...
function buildVisualizationPythonSource(
  ...
  const generatedScript = [
    ...
    '        raise RuntimeError("__PYDANTIC_VISUALIZER_MODEL_SCHEMA_UNAVAILABLE__")',
    '    return __schema',
    '',
    ...
    '        raise RuntimeError("__PYDANTIC_VISUALIZER_FIELD_SCHEMAS_UNAVAILABLE__")',
    '    __field_entry = __fields_schema.get("fields", {}).get(__field)',
    '    if __field_entry is None:',
    '        raise RuntimeError(f"__PYDANTIC_VISUALIZER_MISSING_FIELD__:{__field}")',
    '    __field_schema = __field_entry.get("schema")',
    '    if __field_schema is None:',
    '        raise RuntimeError(f"__PYDANTIC_VISUALIZER_FIELD_SCHEMA_UNAVAILABLE__:{__field}")',
